...
--  where  NumTienda 
		...
		AND fechaNegocio like '20160526%' 
		and NumTienda = '18'
		OPEN Cur1
...
set @fecha ='2016-05-'+ right(@fechastring,2)

set @NumTienda = @NumTienda

/*

SELECT  * FROM CF_DetPago WHERE EXPORTADOTR ='010736'
331.5

update CF_DetPago set TOTAL  =331.5 WHERE EXPORTADOTR ='010736' AND  TIPO ='MASTERCARD' 



update CF_DetPago set ExportadoTr='008750'
where  tipo ='VISA' AND FechaNegocio = '2014-07-30' and NumTienda = '29' 
update CF_DetPago set Total=10  where  ExportadoTr='010549' and tipo  = 'VISA'
where  tipo ='MASTERCARD' AND FechaNegocio = '2014-08-29' and NumTienda = '11' 
*/
