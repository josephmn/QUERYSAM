...
select ch_status,*  from cab_movi order by nu_correla desc 
select*  from det_movi order by nu_correla desc 

delete from cab_movi  where nu_correla between 1 and 28
delete from det_movi  where nu_correla between 1 and 28


select S4Future12,* from newsh s where invcdate  ='2016-11-11'
2494    
