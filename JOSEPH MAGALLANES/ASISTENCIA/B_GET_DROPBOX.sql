...
/****** Object:  Job [B_GET_DROPBOX]    Script Date: 29/07/2019 23:35:32 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 29/07/2019 23:35:32 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'B_GET_DROPBOX', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EJECUCION]    Script Date: 29/07/2019 23:35:32 ******/
